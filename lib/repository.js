...
function productStation(product) {
  ...
  if (category.indexOf("drink") > -1 || ["water", "lemonade", "espresso", "coffee", "beer", "wine", "cocktail"].some(word => name.indexOf(word) > -1)) return "bar";
  if (category.indexOf("pizza") > -1 || name.indexOf("pizza") > -1) return "pizza";
  return "kitchen";
}
